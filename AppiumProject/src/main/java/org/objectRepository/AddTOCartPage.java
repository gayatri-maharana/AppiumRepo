...
public class AddTOCartPage {
	...
	private WebElement convertDynamicXpathToElement(String partialXpath, String replaceData ) {
	...
	public String getProductName(String replaceData) {
		return convertDynamicXpathToElement(productTxt,replaceData).getText();
	}
